...
static int __init via_pmu_start(void)
{
	...
	if (request_irq(sr_irq, pmu_sr_intr, IRQF_SHARED | IRQF_NO_SUSPEND /*| IRQF_DISABLED*/, "VIA-PMU SR", &id_pmu_sr_intr)) {
	 ...
	 */
#ifdef CONFIG_NBPMAC
	if (request_irq(irq, via_pmu_interrupt, /*IRQF_DISABLED |*/ IRQF_SHARED | IRQF_NO_SUSPEND,
			"VIA-PMU", &id_via_pmu_intr)) {
#else
	if (request_irq(irq, via_pmu_interrupt, IRQF_NO_SUSPEND, "VIA-PMU", &id_via_pmu_intr)) {
#endif
		printk(KERN_ERR "via-pmu: can't request irq %d\n", irq);
